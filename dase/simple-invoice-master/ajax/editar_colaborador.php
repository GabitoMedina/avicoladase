<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE colaborador SET nombre_colaborador='".$nombre."', telefono='".$telefono."', email='".$email."', direccion='".$direccion."', status_colaborador='".$estado."' WHERE id_colaborador='".$id_colaborador."'";
