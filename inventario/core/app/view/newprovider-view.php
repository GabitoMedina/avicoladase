<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="product_id" class="form-control" id="product_id" placeholder="Producto">
    </div>
  </div>

	<div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Id Producto*</label>
    <div class="col-md-6">
      <input type="text" name="product_barcode" class="form-control" id="product_barcode" placeholder="Id Producto">
    </div>
  </div>
